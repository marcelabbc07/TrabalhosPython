...
print(lista)
print(lista[0][1],lista[2])
print(f'{lista[1][1]} - {lista[1][2]} - {lista[1][5]} - {lista[1][-1]}')
print(f'{lista[2][1]} - {lista[2][-1]} - {lista[2][2]} - {lista[2][0]}')
print(f'{lista[0][0]}:{lista[1][2]},{lista[1][4]} - {lista[0][1]}:{lista[2][4]},{lista[2][2]} - {lista[0][3]}:{lista[3][2]},{lista[3][4]},{lista[3][5]}')
print(f'{lista[1][0]} - {lista[3][1]},{lista[2][2]},{lista[2][-1]},{lista[1][0]},{lista[2][4]}')
print(f'{lista[0][1]}: 3kg de {lista[1][2]}, 8kg de {lista[1][3]}, 4.5kg de {lista[1][5]}, 1kg de {lista[1][-1]}')
print(f'{lista[0][1]}: 5 maços de {lista[2][-1]}, 4 pés de {lista[2][0]} e {lista[2][1]}, 2 cabeças de {lista[2][4]}')
print(f'{lista[0][3]}: 1kg de {lista[3][0]}, 2kg de {lista[3][5]}, 1.5kg de {lista[3][-1]}, 1 pacote de {lista[3][1]}')
print(lista[0][3],lista[3])
