...
f'{lista_cadastros[0][0]};{lista_cadastros[0][1]};{lista_cadastros[0][2]};{lista_cadastros[0][3]};{lista_cadastros[0][4]};{lista_cadastros[0][5]};
{lista_cadastros[1][0]};{lista_cadastros[1][1]};{lista_cadastros[1][2]};{lista_cadastros[1][3]};{lista_cadastros[1][4]};{lista_cadastros[1][5]};
{lista_cadastros[2][0]};{lista_cadastros[2][1]};{lista_cadastros[2][2]};{lista_cadastros[2][3]};{lista_cadastros[2][4]};{lista_cadastros[2][5]};
{lista_cadastros[3][0]};{lista_cadastros[3][1]};{lista_cadastros[3][2]};{lista_cadastros[3][3]};{lista_cadastros[3][4]};{lista_cadastros[3][5]}'


# 4) Crie uma função que solicite 5 nomes e retorne uma lista com todos eles
def solicitan(n1,n2,n3,n4,n5):
    listan=[]
...
listan2=listan.copy()
listan.append('Pedro Cacetada')
listan2.append('Pedro Paulada')
...
lista_aninhada[].append(10)
lista_aninhada_2[].append('Aqui não pode ter número 10')
...
listan[].append('Pedro Pedroca')
lista_aninhada_2[].append('Pedro Pedroca')
lista_aninhada[].append('um, dois')
lista_aninhada_2[].append('adiciono qualquer coisa em qualquer lugar nessa lista')
