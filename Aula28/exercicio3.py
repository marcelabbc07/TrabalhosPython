...
def recebe_lista():
    lista = [['1', 'Arnaldo', '23', 'm', 'alexcabeludo2@hotmail.com', '014908648117'], 
    ...
    ['50', 'Vanusa', '23', 'm', 'aline_gatinha_13@yahoo.com.br', '015938655596']]
      for j in range(0,59):
        for i in range(0,6):
            print(f'Código:{lista[j][i]} | Nome:{lista[j][i]} | Idade:{lista[j][i]} | Sexo:{lista[j][i]} | Email:{lista[j][i]} | CPF:{lista[j][i]}\n')
    return lista
def retorna_lista(listah,listam):
